...
static const _SineWaveParameters_type_support_symbol_names_t _SineWaveParameters_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rs_control, msg, SineWaveParameters)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rs_control, msg, SineWaveParameters)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rs_control, msg, SineWaveParameters)() {
  return &::rs_control::msg::rosidl_typesupport_c::SineWaveParameters_message_type_support_handle;
}
